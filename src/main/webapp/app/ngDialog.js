        ...
        this.$get = ["$document", "$templateCache", "$compile", "$q", "$http", "$rootScope", "$timeout", "$window", "$controller", function (l, m, n, o, p, q, r, s, t) {
            ...
            var v = {
                onDocumentKeydown: function (a) {
                    ...
                    var d = b.attr("id");
                    "undefined" != typeof a.Hammer ? a.Hammer(b[0]).off("tap", e) : b.unbind("click"), 1 === j && u.unbind("keydown"), b.hasClass("ngdialog-closing") || (j -= 1), g ? b.unbind(h).bind(h, function () {
                        b.scope().$destroy(), b.remove(), 0 === j && (u.removeClass("ngdialog-open"), v.resetBodyPadding()), q.$broadcast("ngDialog.closed", b)
                    }).addClass("ngdialog-closing") : (b.scope().$destroy(), b.remove(), 0 === j && (u.removeClass("ngdialog-open"), v.resetBodyPadding()), q.$broadcast("ngDialog.closed", b)), k[d] && (k[d].resolve({
                        id: d,
                        value: c,
                        $dialog: b,
                        remainingDialogs: j
                ...
                open: function (g) {
                    function h(a, c) {
                        return p.get(a, b.extend({cache: !1}, c || {})).then(function (a) {
                            return a.data || ""
                        })
                    }

                    function i(a) {
                        return a ? b.isString(a) && x.plain ? a : "boolean" != typeof x.cache || x.cache ? m.get(a) || h(a, {cache: !1}) : h(a, {cache: !1}) : "Empty template"
                    }
                    ...
                    return o.when(i(x.template || x.templateUrl)).then(function (c) {
                        if (c = b.isString(c) ? c : c.data && b.isString(c.data) ? c.data : "", m.put(x.template || x.templateUrl, c), x.showClose && (c += '<div class="ngdialog-close"></div>'), l.$result = z = d('<div id="ngdialog' + f + '" class="ngdialog"></div>'), z.html('<div class="ngdialog-overlay"></div><div class="ngdialog-content">' + c + "</div>"), x.data && b.isString(x.data)) {
                        ...
                        return B.closeThisDialog = function (a) {
                            v.closeDialog(z, a)
                        }, r(function () {
                            n(z)(B);
                        ...
                        }), x.closeByEscape && u.bind("keydown", v.onDocumentKeydown), e = function (a) {
                        ...
                        }, "undefined" != typeof a.Hammer ? a.Hammer(z[0]).on("tap", e) : z.bind("click", e), j += 1, w
                    }), {
