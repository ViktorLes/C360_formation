...
describe('registerTrainingSession',function () {
    ...
    /*it('Test our controller',function () {
        console.log("here1 :",datePiker.build());
        console.log("here2 :",ctrl.d1);
        expect(angular.equals(datePiker.build(),datePiker.build())).toBeTruthy();
    });*/
